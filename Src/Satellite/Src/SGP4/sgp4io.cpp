...
{
    static const double xpdotp   =  1440.0 / D2PI;  // 229.1831180523293
    ...
    satrec.a    = pow( satrec.no*tumin , (-2.0/3.0) ); /// 高度
    satrec.ndot = satrec.ndot  / (xpdotp*1440.0);  //* ? * minperday
    satrec.nddot= satrec.nddot / (xpdotp*1440.0*1440);

    // ---- find standard orbital elements ----
    satrec.inclo = satrec.inclo  * DD2R;  /// 轨道倾角
    satrec.nodeo = satrec.nodeo  * DD2R;  /// 升交点赤经
    satrec.argpo = satrec.argpo  * DD2R;  /// 近地点幅角
    satrec.mo    = satrec.mo     * DD2R;  /// 平近点角
    ...
    double dJd1,dJd2;
    iauDtf2d("UTC",year,1,1,0,0,0,&dJd1,&dJd2);
    satrec.jdsatepoch = dJd1+dJd2+satrec.epochdays - 1.0;
