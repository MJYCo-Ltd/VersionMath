                  ...
                  double& zmos)
{
    ...
    xnodce = fmod(4.5236020 - 9.2422029e-4 * day, D2PI);
    stem   = sin(xnodce);
    ctem   = cos(xnodce);
    ...
    zmol = fmod(4.7199672 + 0.22997150  * day - gam, D2PI);
    zmos = fmod(6.2565837 + 0.017201977 * day, D2PI);
                   ...
                   double& xfact, double& xlamo, double& xli,    double& xni)
{
    ...
    if (irez != 0)
    {
        ...
        if (irez == 2)
        {
            ...
            xlamo =  fmod(mo + nodeo + nodeo-theta - theta, D2PI);
        ...
        if (irez == 1)
        {
            ...
            xlamo = fmod(mo + nodeo + argpo - theta, D2PI);
          ...
          double r[3],  double v[3])
{
    ...
    nodem  = fmod(nodem, D2PI);
    argpm  = fmod(argpm, D2PI);
    xlm    = fmod(xlm, D2PI);
    mm     = fmod(xlm - argpm - nodem, D2PI);
...
*                           function gstime
*
*  this function finds the greenwich sidereal time. 格林尼治恒星时
*
...
*
*  outputs       :
*    gstime      - greenwich sidereal time        0 to 2pi rad 格林尼治恒星时
*
*  locals        :
