...
*    这个文件包含了SGP4程序中的卫星的传播分析，
*    of a satellite. the code was originally released in the 1980 and 1986最初发布于
...
typedef struct elsetrec
{
  ...
  /// epochdays 历元时刻在发射年中的天数
  /// ndot      平均运动对时间的一阶导数除2 单位为 圈数/每天2
  /// nddot     平均运动对时间的二阶导数除6 单位为 圈数/每天3
  /// bstar     大气阻力的弹道系数
  /// inclo     轨道倾角(度)
  /// nodeo     升交点赤经(度)
  /// ecco      轨道偏心率(小数表示)
